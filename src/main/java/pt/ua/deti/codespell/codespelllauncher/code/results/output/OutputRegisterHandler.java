...
import pt.ua.deti.codespell.codespelllauncher.code.results.entities.implementation.*;
...
public class OutputRegisterHandler {
    ...
    public CodeExecReport createExecutionReport() {
        ...
        for (CodeResultEntity outputEntity : getOutputEntities()) {
            ...
            } else if (outputEntity instanceof StepsOutputEntity) {
                codeExecReport.setSteps(((StepsOutputEntity) outputEntity).getStepsList());
                codeExecReport.setTips(((StepsOutputEntity) outputEntity).getTips());
            } else if (outputEntity instanceof RuntimeLogsOutputEntity) {
                codeExecReport.setRuntimeLogs(((RuntimeLogsOutputEntity) outputEntity).getRuntimeLogs());
            }
