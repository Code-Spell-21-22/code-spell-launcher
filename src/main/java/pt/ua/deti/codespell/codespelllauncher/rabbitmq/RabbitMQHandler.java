...
public class RabbitMQHandler {
    ...
    private final String queueName = "code-spell-launcher-main-queue";
    ...
    String getRoutingKeyWithTopic(String routingKeyTopic) {
        return routingKey.replace("#", routingKeyTopic);
    }
